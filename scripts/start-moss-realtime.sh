...
# realtime profile: prime 12 text tokens + 80/120 ms buffers + chunk 12
export MOSS_RT_INITIAL_TEXT_CHUNK="${MOSS_RT_INITIAL_TEXT_CHUNK:-1}"
export MOSS_RT_STEADY_TEXT_CHUNK="${MOSS_RT_STEADY_TEXT_CHUNK:-24}"
export MOSS_RT_MIN_SAMPLES_FIRST_MS="${MOSS_RT_MIN_SAMPLES_FIRST_MS:-40}"
export MOSS_RT_MIN_SAMPLES_STEADY_MS="${MOSS_RT_MIN_SAMPLES_STEADY_MS:-80}"
export MOSS_RT_DECODER_CHUNK_FRAMES="${MOSS_RT_DECODER_CHUNK_FRAMES:-24}"
